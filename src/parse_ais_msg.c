...
bool parse_msg_4_11(AISMessage *msg, const char *payload) {
    ...
    msg->year = parse_uint_safe(payload, 38, 14);
    msg->month = parse_uint_safe(payload, 52, 4);
    msg->day = parse_uint_safe(payload, 56, 5);
    msg->hour = parse_uint_safe(payload, 61, 5);
    msg->minute = parse_uint_safe(payload, 66, 6);
    msg->second = parse_uint_safe(payload, 72, 6);
    msg->accuracy = parse_uint_safe(payload, 78, 1);
    msg->lon = parse_lon(payload, 79);
    msg->lat = parse_lat(payload, 107);
    msg->timestamp = parse_uint_safe(payload, 137, 6);
    msg->maneuver = parse_uint_safe(payload, 143, 2);
    msg->fix_type = parse_uint_safe(payload, 143, 4);
    msg->raim = parse_uint_safe(payload, 147, 1);
    msg->radio = parse_uint_safe(payload, 148, 19);
...
bool parse_msg_5(AISMessage *msg, const char *payload) {
    ...
    msg->ship_type = parse_uint_safe(payload, 232, 8);
    msg->dimension_to_bow = parse_uint_safe(payload, 240, 9);
    msg->dimension_to_stern = parse_uint_safe(payload, 249, 9);
    msg->dimension_to_port = parse_uint_safe(payload, 258, 6);
    msg->dimension_to_starboard = parse_uint_safe(payload, 264, 6);
    msg->fix_type = parse_uint_safe(payload, 270, 4);
    msg->eta_month = parse_uint_safe(payload, 274, 4);
    msg->eta_day = parse_uint_safe(payload, 278, 5);
    msg->eta_hour = parse_uint_safe(payload, 283, 5);
    msg->eta_minute = parse_uint_safe(payload, 288, 6);
    msg->draught = parse_uint_safe(payload, 294, 8) / 10.0;
...
bool parse_msg_6(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->seq_num = parse_uint_safe(payload, 38, 2);
    msg->dest_mmsi = parse_uint_safe(payload, 40, 30);
    msg->retransmit = parse_uint_safe(payload, 70, 1);
    msg->spare = parse_uint_safe(payload, 71, 1);
    msg->dac = parse_uint_safe(payload, 72, 10);
    msg->fid = parse_uint_safe(payload, 82, 6);
    ...
    for (int i = 0; i < bin_bytes; i++) {
        msg->bin_data[i] = (char)parse_uint_safe(payload, bin_start + i * 8, 8);
    }
...
bool parse_msg_8(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->spare = parse_uint_safe(payload, 38, 2);
    msg->dac = parse_uint_safe(payload, 40, 10);
    msg->fid = parse_uint_safe(payload, 50, 6);
...
bool parse_msg_9(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->altitude = parse_uint_safe(payload, 38, 12);
    msg->speed = parse_speed(payload, 50);
    msg->accuracy = parse_uint_safe(payload, 60, 1);
    msg->lon = parse_lon(payload, 61);
    msg->lat = parse_lat(payload, 89);
    ...
    msg->heading = parse_heading(payload, 128);
    msg->timestamp = parse_uint_safe(payload, 137, 6);
    msg->alt_sensor = parse_uint_safe(payload, 143, 1);
    msg->spare = parse_uint_safe(payload, 144, 7);
    msg->dte = parse_uint_safe(payload, 151, 1);
    msg->raim = parse_uint_safe(payload, 152, 1);
    msg->radio = parse_uint_safe(payload, 153, 19);
...
bool parse_msg_10(AISMessage *msg, const char *payload) {
    ...
    msg->spare = parse_uint_safe(payload, 38, 2);
    msg->dest_mmsi = parse_uint_safe(payload, 40, 30);
    msg->spare2 = parse_uint_safe(payload, 70, 2);
...
bool parse_msg_15(AISMessage *msg, const char *payload) {
    ...
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->dest_mmsi = parse_uint_safe(payload, 40, 30);
    msg->msg1_id = parse_uint_safe(payload, 70, 6);
    msg->msg1_offset = parse_uint_safe(payload, 76, 12);

    if ((int)(strlen(payload) * 6) > 88) {
        msg->dest2_mmsi = parse_uint_safe(payload, 88, 30);
        msg->msg2_id = parse_uint_safe(payload, 118, 6);
        msg->msg2_offset = parse_uint_safe(payload, 124, 12);
    } else {
        msg->dest2_mmsi = 0;
        msg->msg2_id = 0;
        msg->msg2_offset = 0;
...
bool parse_msg_16(AISMessage *msg, const char *payload) {
    ...
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->dest_mmsi = parse_uint_safe(payload, 40, 30);
    msg->msg1_offset = parse_uint_safe(payload, 70, 12);

    if ((int)(strlen(payload) * 6) > 82) {
        msg->dest2_mmsi = parse_uint_safe(payload, 82, 30);
        msg->msg2_offset = parse_uint_safe(payload, 112, 12);
    } else {
        msg->dest2_mmsi = 0;
        msg->msg2_offset = 0;
    }
    ...
    // Validation
    if (msg->dest_mmsi == 0 || msg->dest_mmsi > 999999999) return false;
    if (msg->msg1_offset > 2240) return false;
    if (msg->dest2_mmsi && (msg->dest2_mmsi > 999999999)) return false;
    if (msg->msg2_offset > 2240) return false;
...
bool parse_msg_17(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->spare = parse_uint_safe(payload, 38, 1);
...
bool parse_msg_18_19_24(AISMessage *msg, const char *payload) {
    ...
    msg->timestamp = parse_uint_safe(payload, 133, 6);
    msg->raim = parse_uint_safe(payload, 148, 1);
    msg->radio = parse_uint_safe(payload, 149, 19);
    ...
    if (msg->type == 19) {
        msg->ship_type = parse_uint_safe(payload, 143, 8);
        msg->callsign = parse_string_utf8(payload, 151, 42);
        msg->vessel_name = parse_string_utf8(payload, 193, 120);
        msg->dimension_to_bow = parse_uint_safe(payload, 313, 9);
        msg->dimension_to_stern = parse_uint_safe(payload, 322, 9);
        msg->dimension_to_port = parse_uint_safe(payload, 331, 6);
        msg->dimension_to_starboard = parse_uint_safe(payload, 337, 6);
        msg->fix_type = parse_uint_safe(payload, 343, 4);
    } else if (msg->type == 24) {
        int part = parse_uint_safe(payload, 38, 2);
        if (part == 0) {
            msg->vessel_name = parse_string_utf8(payload, 40, 120);
        } else if (part == 1) {
            msg->callsign = parse_string_utf8(payload, 40, 42);
            msg->ship_type = parse_uint_safe(payload, 82, 8);
            msg->dimension_to_bow = parse_uint_safe(payload, 90, 9);
            msg->dimension_to_stern = parse_uint_safe(payload, 99, 9);
            msg->dimension_to_port = parse_uint_safe(payload, 108, 6);
            msg->dimension_to_starboard = parse_uint_safe(payload, 114, 6);
            msg->fix_type = parse_uint_safe(payload, 120, 4);
        }
    }
...
bool parse_msg_20(AISMessage *msg, const char *payload) {
    ...
    msg->offset1 = parse_uint_safe(payload, 40, 12);
    msg->num_slots1 = parse_uint_safe(payload, 52, 4);
    msg->timeout1 = parse_uint_safe(payload, 56, 3);
    msg->increment1 = parse_uint_safe(payload, 59, 11);

    if ((int)(strlen(payload) * 6) > 70) {
        msg->offset2 = parse_uint_safe(payload, 70, 12);
        msg->num_slots2 = parse_uint_safe(payload, 82, 4);
        msg->timeout2 = parse_uint_safe(payload, 86, 3);
        msg->increment2 = parse_uint_safe(payload, 89, 11);
    }
    if ((int)(strlen(payload) * 6) > 100) {
        msg->offset3 = parse_uint_safe(payload, 100, 12);
        msg->num_slots3 = parse_uint_safe(payload, 112, 4);
        msg->timeout3 = parse_uint_safe(payload, 116, 3);
        msg->increment3 = parse_uint_safe(payload, 119, 11);
    }
    if ((int)(strlen(payload) * 6) > 130) {
        msg->offset4 = parse_uint_safe(payload, 130, 12);
        msg->num_slots4 = parse_uint_safe(payload, 142, 4);
        msg->timeout4 = parse_uint_safe(payload, 146, 3);
        msg->increment4 = parse_uint_safe(payload, 149, 11);
    }
...
bool parse_msg_21(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->aid_type = parse_uint_safe(payload, 38, 5);
    msg->vessel_name = parse_string_utf8(payload, 43, 120);
    msg->accuracy = parse_uint_safe(payload, 163, 1);
    msg->lon = parse_lon(payload, 164);
    msg->lat = parse_lat(payload, 192);
    msg->dimension_to_bow = parse_uint_safe(payload, 219, 9);
    msg->dimension_to_stern = parse_uint_safe(payload, 228, 9);
    msg->dimension_to_port = parse_uint_safe(payload, 237, 6);
    msg->dimension_to_starboard = parse_uint_safe(payload, 243, 6);
    msg->fix_type = parse_uint_safe(payload, 249, 4);
    msg->timestamp = parse_uint_safe(payload, 253, 6);
    msg->off_position = parse_uint_safe(payload, 259, 1);
    msg->raim = parse_uint_safe(payload, 268, 1);
    msg->virtual_aid = parse_uint_safe(payload, 269, 1);
    msg->assigned = parse_uint_safe(payload, 270, 1);
    msg->spare = parse_uint_safe(payload, 271, 1);
    msg->radio = parse_uint_safe(payload, 272, 19);
...
bool parse_msg_22(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->channel_a = parse_uint_safe(payload, 40, 12);
    msg->channel_b = parse_uint_safe(payload, 52, 12);
    msg->txrx_mode = parse_uint_safe(payload, 64, 4);
    msg->power = parse_uint_safe(payload, 68, 1);
    ...
    msg->addressed = parse_uint_safe(payload, 141, 1);
    msg->bandwidth_a = parse_uint_safe(payload, 142, 1);
    msg->bandwidth_b = parse_uint_safe(payload, 143, 1);
    msg->zone_size = parse_uint_safe(payload, 144, 3);
    msg->spare = parse_uint_safe(payload, 147, 1);
...
bool parse_msg_23(AISMessage *msg, const char *payload) {
    ...
    msg->station_type = parse_uint_safe(payload, 112, 4);
    msg->type_of_ship = parse_uint_safe(payload, 116, 8);
    msg->txrx_mode = parse_uint_safe(payload, 124, 2);
    msg->interval = parse_uint_safe(payload, 126, 4);
    msg->quiet = parse_uint_safe(payload, 130, 4);
    msg->spare = parse_uint_safe(payload, 134, 6);
...
bool parse_msg_25(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->addressed = parse_uint_safe(payload, 38, 1);
    msg->structured = parse_uint_safe(payload, 39, 1);
    ...
    if (msg->structured) {
        msg->app_id = parse_uint_safe(payload, app_id_start, 16);
        app_id_start += 16;
    }
    ...
    for (int i = 0; i < bin_bytes; i++) {
        msg->bin_data[i] = (char)parse_uint_safe(payload, app_id_start + i * 8, 8);
    }
...
bool parse_msg_26(AISMessage *msg, const char *payload) {
    ...
    if (msg->addressed) {
        msg->dest_mmsi = parse_uint_safe(payload, 40, 30);
        msg->seq_num = parse_uint_safe(payload, 70, 2);
        app_id_start += 32;
    }
    if (msg->structured) {
        msg->app_id = parse_uint_safe(payload, app_id_start, 16);
...
bool parse_msg_27(AISMessage *msg, const char *payload) {
    ...
    msg->repeat = parse_uint_safe(payload, 6, 2);
    msg->mmsi = parse_uint_safe(payload, 8, 30);
    msg->accuracy = parse_uint_safe(payload, 38, 1);
    msg->raim = parse_uint_safe(payload, 39, 1);
    msg->status = parse_uint_safe(payload, 40, 4);
    msg->lon = parse_lon(payload, 44);
    msg->lat = parse_lat(payload, 62);
    msg->speed = parse_speed(payload, 79);
    msg->course = parse_uint_safe(payload, 85, 9) / 10.0;
    msg->gnss = parse_uint_safe(payload, 94, 1);
